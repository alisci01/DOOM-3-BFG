...
public:
	...
	static void					CopyArgs( const idEventDef *evdef, int numargs, va_list args, void *data[ D_EVENT_MAXARGS ]  );
...
================
*/
ID_INLINE int idEventDef::GetArgSize() const {
	return static_cast<int>( argsize );
}
